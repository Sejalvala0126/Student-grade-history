const  calculate = () =>{
    ...
    if(web == " " || maths == " " || comp == " " || phy == " ")
    {
        ...
        if(percentage >=39.5)
        {
            ...
            document.querySelector("#showdata").innerHTML = `Out of 400, your total is ${totalgrades} and percentage is  ${percentage}.00%  Your grade is ${grades}. You Passed.`; 
        }

        else{

            document.querySelector("#showdata").innerHTML  = `Out of 400, your total is ${totalgrades} and percentage is  ${percentage}.00% Your grade is ${grades}. You Fail.`; 
        }
